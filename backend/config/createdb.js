...
const dbConfig = {
  host: "localhost",
  user: "the-mole", // MySQL username
  password: "masterkey", // MySQL password
...
const insertDataQueries = [
  ...
  ('admin', 'Lucas', 'A', 'lucas@1.se', '$2y$10$UsERLt26PF3iD9JV0HDJkeltgPGktfyGB0TVDjp25J/pJzNj7XFeC', "123-456-7890"),
